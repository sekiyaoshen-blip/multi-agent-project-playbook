...
```text
Install the Multi-Agent Model skill from https://github.com/sekiyaoshen-blip/multi-agent-model into this machine's local agent skill directory.
...
```text
请从 https://github.com/sekiyaoshen-blip/multi-agent-model 安装 Multi-Agent Model skill 到这台机器的本地 Agent skill 目录。
